  		                ...
  		                <div class="col-lg-12 col-md-8">
												...
												echo form_open('Materia/associar', $atributos).
													 ...
													 if($this->session->userdata('tipo') == 1){
														 ...
														 form_label("1° Info Int", "txt_1i") . /*"</th><th>"*/br().
														 form_checkbox("turma[]", "12", FALSE) .
														 form_label("2° Info Int", "txt_1i") ./*"</th><th>"*/br().
														 form_checkbox("turma[]", "13", FALSE) . 
														 form_label("3° Info Int", "txt_1i") ./*"</th><th>"*/br().
														 form_checkbox("turma[]", "41", FALSE) .
														 form_label("1° Info Sub", "txt_1i") ./*"</th><th>"*/br().
														 form_checkbox("turma[]", "52", FALSE).
														 form_label("2° Info Sub", "txt_1i").br();
													}
													 else if($this->session->userdata('tipo') == 2){
														 echo form_checkbox("turma[]", "21", FALSE) .
														 form_label("1° Meca Int", "txt_1i") ./*"</th><th>"*/br().
														 form_checkbox("turma[]", "22", FALSE) . 
														 form_label("2° Meca Int", "txt_1i") ./*"</th><th>"*/br().
														 form_checkbox("turma[]", "23", FALSE) . 												 
														 form_label("3° Meca Int", "txt_1i") ./*"</th><th>"*/br().
														 form_checkbox("turma[]", "51", FALSE) .
														 form_label("1° Meca Sub", "txt_1i") ./*"</th><th>"*/br().
														 form_checkbox("turma[]", "62", FALSE).
														 form_label("2° Meca Sub", "txt_1i").br();
													 }
													 else if($this->session->userdata('tipo') == 3){
														 echo form_checkbox("turma[]", "31", FALSE) .
														 form_label("1° Edif Int", "txt_1i");/*"</th><th>"*/br().
														 form_checkbox("turma[]", "32", FALSE) .
														 form_label("2° Edif Int", "txt_1i") ./*"</th><th>"*/br().
														 ...
														 form_label("2° Edif Sub", "txt_1i").br();
													 }
													 else if($this->session->userdata('tipo') == 6){
														 echo form_checkbox("turma[]", "11", FALSE) .
														 form_label("1° Info Int", "txt_1i") . /*"</th><th>"*/br().
														 form_checkbox("turma[]", "12", FALSE) .
														 form_label("2° Info Int", "txt_1i") ./*"</th><th>"*/br().
														 ...
														 form_label("2° Edif Int", "txt_1i") ./*"</th><th>"*/br().
														 form_checkbox("turma[]", "33", FALSE) .
														 form_label("3° Edif Int", "txt_1i").br();/*"</th></tr></table>"*/
												 }
													 echo form_submit("btn_cadastrar", " Salvar ", $btn).
													form_close().
