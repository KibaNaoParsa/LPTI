 ...
 <li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <!--
                        ...
                        <li>
                            <a href="tables.html"><i class="fa fa-table fa-fw"></i> Conjunto</a>
                        </li>
                        ...
                        */ ?>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-sitemap fa-fw"></i> Grupo Elyas<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                           ...
                           -->
                                ...
                                <li>
                                    ...
                                    <ul class="nav nav-third-level">
                                        <li>
                                            <?php
                                              echo anchor(base_url("gerenciar/call_tela_cadastro"), "Usu&aacuterio");
                                            ?>
                                            <!--<a href="#">Usu&aacuterios</a>-->
                                        </li>
                                        <li>
                                            <a href="#">Question&aacuterios</a>
                                        </li>
                                    </ul>
                                    <!-- /.nav-third-level -->
                                </li>
                                ...
                                <li>
                                    <a href="#">Editar <span class="fa arrow"></span></a>
                                    <ul class="nav nav-third-level">
                                        <li>
                                            <?php
                                              echo anchor(base_url("gerenciar/call_listar_cadastro"), "Usu&aacuterio");
                                            ?>
                                        </li>
                                        <li>
                                            <a href="#">Question&aacuterios</a>
        ...
        <div id="page-wrapper">
       		...
       		<?php
        			...
        			echo form_open(base_url('gerenciar/salvar_alteracao'), $atributos).
